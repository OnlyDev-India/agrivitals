...
const steps = [
  {
    ...
    description: "High-efficiency solar panels capture sunlight and convert it into thermal energy.",
    color: "from-yellow-400 to-orange-500"
  },
  {
    icon: <Wind className="w-8 h-8 text-white" />,
    title: "Air is Heated and Circulated",
    description: "The collected solar energy heats air which is then circulated through the system.",
    color: "from-blue-400 to-cyan-500"
  },
  {
    icon: <Package className="w-8 h-8 text-white" />,
    title: "Crops are Placed in Drying Chambers",
    description: "Fresh crops are loaded into specially designed drying chambers.",
    color: "from-green-400 to-emerald-500"
  },
  {
    icon: <Droplets className="w-8 h-8 text-white" />,
    title: "Moisture is Removed Efficiently",
    description: "Warm air circulates through the crops, removing moisture gradually and evenly.",
    color: "from-purple-400 to-pink-500"
  },
  {
    icon: <CheckCircle className="w-8 h-8 text-white" />,
    title: "Dried Crops are Ready for Storage",
    description: "Perfectly dried crops are ready for long-term storage and preservation.",
...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 bg-gradient-to-br from-gray-50 to-green-50 dark:from-gray-900 dark:to-green-950">
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Our solar dryer uses a simple yet effective process to preserve your crops naturally. 
        ...
        <div className="relative">
          {/* Connection line */}
          <div className="absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-yellow-400 via-blue-400 via-green-400 via-purple-400 to-green-500 transform -translate-y-1/2 hidden lg:block"></div>
            ...
            <div className="relative w-full max-w-4xl">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-center space-y-3">
                  ...
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Solar Panel</p>
                </div>
                ...
                <div className="text-center space-y-3">
                  ...
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Air Heater</p>
                </div>
                ...
                <div className="text-center space-y-3">
                  ...
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Drying Chamber</p>
                </div>
                ...
                <div className="text-center space-y-3">
                  ...
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Moisture Removal</p>
                </div>
                ...
                <div className="text-center space-y-3">
                  ...
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Dried Crops</p>
                </div>
              </div>
            </div>
          </div>
